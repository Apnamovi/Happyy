...
PICS = (environ.get('PICS', 'https://telegra.ph/file/c9fd55aeeefa44a4c99eb.jpg')).split()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5554564210 6284344479 5069888600 5675198274 1991522624').split()]
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>Title:</b> <code>{file_caption}</code> <a href=https://t.me/The_Happy_Hour_Hindi>The Happy Hour</a> \n\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n👉 <b>Join Now : <a href=https://t.me/The_Happy_Hour_Hindi>The Happy Hour</a></b> 👈")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "<b>Title:</b> <code>{file_caption}</code> <a href=https://t.me/The_Happy_Hour_Hindi>The Happy Hour</a> \n\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n👉 <b>Join Now : <a href=https://t.me/The_Happy_Hour_Hindi>The Happy Hour</a></b> 👈")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>🍿 Title: {title}\n🌟 Rating : {rating}/10\n🎭 Genres: {genres}\n📆 Year: {year}\n⏰ Duration : {runtime}\n\n<a href=https://t.me/The_Happy_Hour_Hindi>♥️ Please Share An Support ♥️</a>\n<a href=https://t.me/The_Happy_Hour_Movie_Request_bot?start=ZmlsZV9CQUFEQlFBRDhna0FBbDgtb1ZZSmpzbnNIZzhmb0JZRQ>Copyright के कारण बोट को अपडेट किया गया है आपको पहले को लिंक वेरिफिकेशन करना होगा\लिंक वेरिफिकेशन कैसे करना ये वीडियो देखे</a></b>")
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', '-1001916094593'))
...
DOWNLOAD_TEXT_URL = "https://Letest_All_Type_Movies"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Letest_All_Type_Movies"
