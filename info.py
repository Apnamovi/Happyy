...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>🍿 Title: {title}\n🌟 Rating : {rating}/10\n🎭 Genres: {genres}\n📆 Year: {year}\n⏰ Duration : {runtime}\n\n<a href=https://t.me/The_Happy_Hour_Hindi>♥️ Please Share An Support ♥️</a>\n<a href=https://t.me/The_Happy_Hour_Movie_Request_bot?start=ZmlsZV9CQUFEQlFBRDhna0FBbDgtb1ZZSmpzbnNIZzhmb0JZRQ>Copyright के कारण बोट को अपडेट किया गया है आपको पहले को लिंक वेरिफिकेशन करना होगा\लिंक वेरिफिकेशन कैसे करना ये वीडियो देखे</a>\n👇👇👇👇👇👇👇</b>")
