...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('📥 Join BackUp Channel 📥', url=f'https://t.me/The_Happy_Hour_Hindi')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f'https://t.me/The_Happy_Hours'),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('📥 Join Backup Channel 📥', url=f'https://t.me/Latest_movies_freeOnNet')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('📥 Join BackUp Channel 📥', url='https://t.me/The_Happy_Hour_Hindi')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
